...
(async () => {
  try {
    ...
    const url = "https://everymac.com/systems/apple/mac_mini/index-macmini.html";
    ...
    const macbookData = await page.evaluate(() => {
      const models = [];
      const containers = document.querySelectorAll("div[id^='contentMacMini']");
    ...
    fs.writeFileSync("MacMini_models.json", JSON.stringify(macbookData, null, 2));
    console.log("Datos guardados en MacMini_models.json");
