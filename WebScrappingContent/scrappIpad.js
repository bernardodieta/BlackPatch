...
(async () => {
  try {
    ...
    const url = "https://everymac.com/systems/apple/ipad/index-ipad-specs.html";
    ...
    fs.writeFileSync("iPad_models.json", JSON.stringify(macbookData, null, 2));
    console.log("Datos guardados en iPad_models.json");
