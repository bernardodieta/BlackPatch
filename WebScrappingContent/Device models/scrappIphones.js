...
(async () => {
    ...
    containers.forEach(container => {
      ...
      rows.forEach(row => {
        ...
        if (cells.length === 4) {
          ...
          // Cambiar 'id' a 'ident' si es necesario
          if (cleanKey1 === 'id') {
            cleanKey1 = 'ident';
          }
          if (cleanKey2 === 'id') {
  ...
  fs.writeFileSync("Iphones_models.json", JSON.stringify(macbookData, null, 2));
  console.log("Datos guardados en Iphones_models.json");
