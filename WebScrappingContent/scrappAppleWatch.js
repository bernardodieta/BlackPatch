...
(async () => {
  try {
    ...
    const url = "https://everymac.com/systems/apple/apple-watch/index-apple-watch-specs.html";
    ...
    const macbookData = await page.evaluate(() => {
      const models = [];
      const containers = document.querySelectorAll("div[id^='contentAppleWatch']");
    ...
    fs.writeFileSync("AppleWatch_models.json", JSON.stringify(macbookData, null, 2));
    console.log("Datos guardados en AppleWatch_models.json");
