...
(async () => {
  try {
    const url = "https://everymac.com/systems/apple/ipad/";
    ...
    fs.writeFileSync("Ipads_with_details.json", JSON.stringify(iphoneData, null, 2));
    console.log("Datos guardados en Ipads_with_details.json");
