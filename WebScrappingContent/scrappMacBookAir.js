...
(async () => {
  try {
    ...
    const url = "https://everymac.com/systems/apple/macbook-air/index-macbook-air.html";
    ...
    const macbookData = await page.evaluate(() => {
      const models = [];
      const containers = document.querySelectorAll("div[id^='contentMacBookAir']");
    ...
    fs.writeFileSync("macbookAir_models.json", JSON.stringify(macbookData, null, 2));
    console.log("Datos guardados en macbookAir_models.json");
